...
Μετά απο αμέτρητα παραδείγματα και εξάσκηση και τρια καμμένα buzzer-Piezo καταφέραμε να φτιάξουμε ένα κώδικα που θα περιείχε και τα led μας και τον ήχο. Παρολαυτα βίντεο με την τελευταια υλοποιήση δεν καταφέραμε να τραβήξουμε βίντεο μας καήκε και το τελευταιο δανεικο buzzer μας . 
