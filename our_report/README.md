...
Έπειτα οταν στέγνωσε η μπογία μας , αποφασίσαμε που θα τοποθετήσουμε τα led μας πάνω στον καμβά. Οταν το αποφασίσαμε αρχισαμε να βάζουμε την χάλκινη ταινία και δημιουργόυσαμε ενα μονοπάτι στο καθε led ωστε να ειναι ετοιμα για συγκόλληση. Η συγκόλληση ήταν ενα απαιτητικό μερος της διαδικασίας, παρολαυτα καταφέραμε να τα συνδέσουμε ολα. 
...
Αφού ολοκληρώσαμε και το στάδιο της συγκόλλησης , έπρεπε να τεστάρουμε ξεχωριστά τους κώδικες για να ανάβουν τα led μας αλλα και να παίζει ο ήχος απο την αφή του χρήστη. Άρα ξεκινήσαμε να δούμε αν λειτουργούν τα led μας με την αφή του χρήστη και το αποτέλεσμα μας ηταν αυτό. 


https://user-images.githubusercontent.com/101418644/172959926-38a294f9-40df-49f2-b96e-0be82586bc39.mp4

Αφου τεστάραμε τον κωδικά μας οτι τρέχει κανονικά το υλοποιήσαμε και στον καμβά , η ανασυχία μας σε αυτο το κομμάτι ήταν οτι οι τιμές οταν ακουμπάγαμε τον καλώδιο δεν ήταν σταθερές και άλλαζαν συνεχώς. 
...
Έπειτα αφου ολοκληρώσαμε αυτο το στάδιο , ψάξαμε κώδικες για το buzzer . Αρχικά τεστάραμε να παίζει οποιαδήποτε τραγούδι θέλαμε . 
...
Αφου καταλάβαμε και αυτο το κομμάτι επρεπε να τεστάρουμε το buzzer μας να ενεργοποιείτε απο την αφή του χρήστη 
...
Αφου ολοκληρώσαμε και αυτο το στάδιο , το υλοποιήσαμε στον καμβά μας
